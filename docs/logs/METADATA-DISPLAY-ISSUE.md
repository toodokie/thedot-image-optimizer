...
- [class-msh-image-optimizer.php](../../includes/class-msh-image-optimizer.php) - Backend analyze logic
- [image-optimizer-modern.js](../../assets/css/image-optimizer-modern.js) - Frontend display logic
- Lines of interest:
