...
### 1. Backend - PHP ([class-msh-image-optimizer.php](../../includes/class-msh-image-optimizer.php))
...
### 2. Frontend - JavaScript ([image-optimizer-modern.js](../../assets/css/image-optimizer-modern.js))
...
### 3. Version Bump ([msh-image-optimizer.php](../../msh-image-optimizer.php))
...
1. **[class-msh-image-optimizer.php](../../includes/class-msh-image-optimizer.php)**
...
2. **[image-optimizer-modern.js](../../assets/css/image-optimizer-modern.js)**
...
3. **[msh-image-optimizer.php](../../msh-image-optimizer.php)**
...
- **[TEST-PLAN.md](../testing/TEST-PLAN.md)** - Testing instructions for Reset button (previous fix)
