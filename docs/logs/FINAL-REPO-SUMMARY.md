...
- [GIT-COMMIT-STRATEGY.md](../guides/GIT-COMMIT-STRATEGY.md) - Detailed commit workflow
- [REPO-MAP.md](../architecture/REPO-MAP.md) - Repository structure map
- [PHASE-6-IMPLEMENTATION-COMPLETE.md](../archive/PHASE-6-IMPLEMENTATION-COMPLETE.md) - What's in Phase 6
