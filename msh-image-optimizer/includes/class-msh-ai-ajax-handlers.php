...
class MSH_AI_Ajax_Handlers {
    ...
    public function __construct() {
        add_action('wp_ajax_msh_get_ai_regen_counts', [$this, 'get_regen_counts']);
        add_action('wp_ajax_msh_estimate_ai_regeneration', [$this, 'estimate_regeneration']);
        add_action('wp_ajax_msh_get_ai_credit_balance', [$this, 'get_credit_balance']);
    }
