        ...
        foreach ($attachment_ids as $attachment_id) {
            ...
            if (!empty($metadata)) {
                ...
                if (!empty($metadata['title'])) {
                    wp_update_post(array('ID' => $attachment_id, 'post_title' => $metadata['title']));
                }
                ...
                if (!empty($metadata['caption'])) {
                    wp_update_post(array('ID' => $attachment_id, 'post_excerpt' => $metadata['caption']));
                }
                if (!empty($metadata['description'])) {
                    wp_update_post(array('ID' => $attachment_id, 'post_content' => $metadata['description']));
                }
