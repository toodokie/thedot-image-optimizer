...
<?php
/**
 * Fix files that were incorrectly marked as having guards
 * These files have class_exists() checks for DEPENDENCIES, not for themselves
 */
...
echo "Checking " . count($class_files) . " class files\n\n";
