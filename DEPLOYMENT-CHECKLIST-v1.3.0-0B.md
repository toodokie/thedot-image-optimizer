...
Follow the detailed instructions in [WIDGET-INTEGRATION-GUIDE.md](WIDGET-INTEGRATION-GUIDE.md).
...
Follow the monitoring queries in [PRODUCTION-RUNBOOK.md](PRODUCTION-RUNBOOK.md).
...
If any metric fails, refer to [PRODUCTION-RUNBOOK.md](PRODUCTION-RUNBOOK.md) for troubleshooting.
